...
class General(commands.Cog):
    ...
    async def _connect(self, ctx:commands.Context):  # dest_channel_name: str
    ...
    async def _disconnect(self, ctx:commands.Context, guild=False):
        current_guild = utils.get_guild(self.bot, ctx.message)
        audiocontroller = utils.guild_to_audiocontroller[current_guild]
    ...
    async def _change_channel(self, ctx:commands.Context):
        current_guild = utils.get_guild(self.bot, ctx.message)
    ...
    async def _addbot(self, ctx:commands.Context):
