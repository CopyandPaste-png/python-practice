...
killerInfo={
'Unnerving Presence' : {'name': 'Trapper', 'description': "Your presence alone instils great fear. Survivors within your Terror Radius have a 10 % greater chance of triggering Skill Checks when repairing, healing or sabotaging. Triggered Skill Checks' success zones are reduced by 60 %.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/UnnervingPresence.png'} ,
'Brutal Strength' : {'name': 'Trapper', 'description': "Your great strength allows you to shred through your prey's defences. Destroy dropped Pallets and damage Generators 20 % faster.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/BrutalStrength.png'} ,
'Agitation' : {'name': 'Trapper', 'description': 'You get excited in anticipation of hooking your prey. Increases your Movement speed while transporting bodies by 18 %. While transporting a body, your Terror Radius is increased by 12 metres.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Agitation.png'} ,
'Predator' : {'name': 'Wraith', 'description': 'Your acute tracking ability allows you to hone in on disturbances left by running Survivors. Scratch Marks left by Survivors will spawn slightly/moderately/considerably closer together.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Predator.png'} ,
'Bloodhound' : {'name': 'Wraith', 'description': 'Like a hunting scent hound, you smell traces of blood at a great distance. Fresh Blood Stains are considerably more discernible than normal and can be tracked for 4 seconds longer than normal.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Bloodhound.png'} ,
'Shadowborn' : {'name': 'Wraith', 'description': 'You have a keen vision in the darkness of the night. Your Field of View is increased by 15 É. Field of View gains do not stack.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Shadowborn.png'} ,
'Enduring' : {'name': 'Hillbilly', 'description': 'You are resilient to pain. You reduce the duration of Pallet Stuns by 50 %.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Enduring.png'} ,
'Lightborn' : {'name': 'Hillbilly', 'description': 'Unlike other beasts of The Fog, you have adapted to light. Resistance to Blindness is increased by 80 %. Recovery from Blindness is increased by 50 %.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Lightborn.png'} ,
'Tinkerer' : {'name': 'Hillbilly', 'description': 'When a Generator is repaired to 85 %, you receive a Loud Noise notification and your Terror Radius is reduced to 0 metres for 12 seconds.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Tinkerer.png'} ,
'Stridor' : {'name': 'Nurse', 'description': "You are acutely sensitive to the breathing of your prey. Survivors' Grunts of Pain are 50 % louder and regular breathing is 25 % louder.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Stridor.png'} ,
'Thanatophobia' : {'name': 'Nurse', 'description': 'Their courage fades in the face of their undeniable mortality. For each injured, dying or hooked Survivor, all Survivors receive a penalty of 4/4.5/5 % to their Repair, Sabotage, and Totem-Cleansing speed, stack-able up to a maximum of 16/18/20%.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Thanatophobia.png'} ,
'A Nurse\'s Calling' : {'name': 'Nurse', 'description': "Unlocks potential in one's Aura-reading ability. The Auras of Survivors who are healing or being healed are revealed to you when they are within a range of 28 metres,", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/AnursesCalling.png'} ,
'Save the Best for Last' : {'name': 'Myers', 'description': 'You become obsessed with one Survivor. Earn a Token for each successful hit that is not dealt to the Obsession. Each Token grants a stack-able 5 % cool-down reduction on successful attacks. You can earn up to 8 Tokens. Attacking your Obsession will make you lose 2 Tokens. You can no longer gain Tokens if your Obsession is sacrificed or killed. You can only be obsessed with one Survivor at a time.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/SavetheBestforLast.png'} ,
'Play with Your Food' : {'name': 'Myers', 'description': 'You become obsessed with one Survivor. Every time you chase your Obsession and let them escape, you receive a Token up to a maximum of 3 Tokens. Each Token increases your Movement speed by 5 %. Each offensive action spends 1 Token. You can only be obsessed with one Survivor at a time.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/PlaywithYourFood.png'} ,
'Dying Light' : {'name': 'Myers', 'description': 'You become obsessed with one Survivor. Your Obsession gains a 33 % Action Speed bonus to unhooking and healing other Survivors. Each time you hook a Survivor that is not the Obsession and the Obsession is alive, gain a Token. If the Obsession is alive, all others Survivors get a stack-able 3 % penalty to Repair, Healing, and Sabotage speed for each Token. You can only be obsessed with one Survivor at a time.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/DyingLight.png'} ,
'Hex: The Third Seal' : {'name': 'Hag', 'description': "A Hex that hinders one's Aura-reading ability. Hitting a Survivor while the Hex Totem is active applies the Blindness Status Effect. This effect applies to the last 4 Survivors hit. The Hex effects persist as long as the related Hex Totem is standing.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/HexTheThirdSeal.png'} ,
'Hex: Ruin' : {'name': 'Hag', 'description': "A Hex that affects the Survivors' skills at repairing Generators. All Survivors are affected by Ruin, which causes the following: É Good Skill Checks result in a 5 % Regression penalty on the Generator. É Great Skill Checks grant 0 % Bonus Progression on the Generator. The Hex effects persist as long as the related Hex Totem is standing.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/HexRuin.png'} ,
'Hex: Devour Hope' : {'name': 'Hag', 'description': 'A Hex rooting its power on hope. The false hope of Survivors ignites your hunger. When a Survivor is rescued from a Hook at least 24 metres away, Devour Hope receives a Token. É 2 Tokens: Gain a 3/4/5 % Haste Status Effect 10 seconds after hooking a Survivor, for a duration of 10 seconds. É 3 Tokens: Survivors suffer from the Exposed Status Effect. É 5 Tokens: Grants the ability to kill Survivors by your own hand. The Hex effects persist as long as the related Hex Totem is standing.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/HexDevourHope.png'} ,
'Overwhelming Presence' : {'name': 'Doctor', 'description': "Your presence alone instils great fear. Survivors within your Terror Radius suffer from inefficiency. Affected Survivors' Item Consumption rates are increased by 100 %.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/OverwhelmingPresence.png'} ,
'Monitor and Abuse' : {'name': 'Doctor', 'description': 'Meticulous in your approach, terrifying in your application. While in a Chase, your Terror Radius is increased by 8 metres. Otherwise, your Terror Radius is decreased by 8 metres and your Field of View is increased by 10 É. Field of View gains do not stack.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/MonitorAbuse.png'} ,
'Overcharge' : {'name': 'Doctor', 'description': 'You are fuelled by your hate for progress. Overcharge a Generator by performing the Damage Generator action. The next Survivor interacting with that Generator is faced with a tremendously difficult Skill Check. Failing the Skill Check results in an additional 5 % Regression penalty. Succeeding the Skill Check grants no progress, but prevents the Generator Explosion.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Overcharge.png'} ,
'Beast of Prey' : {'name': 'Huntress', 'description': 'Your lust for a kill is so intense that your connection with The Entity is momentarily lost, making you totally unpredictable. The Red Stain disappears after gaining Bloodlust Tier I and stays hidden until you lose Bloodlust. Gain 50 % more Bloodpoints for actions in the Hunter Category.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/BeastofPrey.png'} ,
'Territorial Imperative' : {'name': 'Huntress', 'description': "Unlocks potential in one's Aura-reading ability. Survivors' Auras are revealed to you for 3 seconds when they enter the Basement and you are more than 32 metres away from the Basement entrance. Territorial Imperative can only be triggered once every 20 seconds.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/TerritorialImperative.png'} ,
'Hex: Huntress Lullaby' : {'name': 'Huntress', 'description': "A Hex rooting its power in despair. Your hunt is an irresistible song of dread which muddles your prey's attention. Survivors receive a 6 % Regression penalty when missing any Skill Check. Each time a Survivor is hooked, Huntress Lullaby grows in power: É 1 to 4 Tokens: Time between the Skill Check warning sound and the Skill Check becomes shorter. É 5 Tokens: No Skill Check warning. The Hex effects persist as long as the related Hex Totem is standing.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/HexHuntressLullaby.png'} ,
'Knock Out' : {'name': 'Cannibal', 'description': "The trauma caused by your brutal attacks makes crying for help painfully difficult. Dying Survivors' Auras are not revealed to other Survivors when they are standing outside of a range of 16 metres.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/KnockOut.png'} ,
'Barbecue and Chilli' : {'name': 'Cannibal', 'description': "A deep bond with The Entity unlocks potential in one's Aura-reading ability. After hooking a Survivor, all other Survivors' Auras are revealed to you for 4 seconds when they are farther than 40 metres from the Hook. Each time a Survivor is hooked for the first time, gain a 25 % stack-able bonus to all Bloodpoint gains up to a maximum of 100 %. The bonus Bloodpoints are only awarded post-Trial.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/BarbecueChilli.png'} ,
'Franklin\'s Demise' : {'name': 'Cannibal', 'description': 'Your vicious Basic Attacks make the Survivors drop their Item on impact. The lost Item is damaged in the fall, losing 10 % of its base amount of Charges.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/FranklinsDemise.png'} ,
'Fire Up' : {'name': 'Freddy', 'description': 'The increased pressure of losing your preys fills you with anger and gives you unsuspected motivation. Each time the Survivors complete repairs on a Generator, Fire Up grows in power. É For each Generator completed, gain a stack-able 4 % buff to Picking-Up, Dropping, Pallet Breaking, Generator Damaging and Vaulting speeds for the remainder of the Trial.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/FireUp.png'} ,
'Remember Me' : {'name': 'Freddy', 'description': 'You become obsessed with one Survivor. Each time you hit your Obsession, you increase the Exit Gate Opening time by 4 seconds up to a maximum of 16 additional seconds. The Obsession is not affected by Remember Me. You can only be obsessed with one Survivor at a time.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/RememberMe.png'} ,
'Blood Warden' : {'name': 'Freddy', 'description': 'As soon as the Exit Gate is opened, Blood Warden is activated. The Auras of any Survivors located within Exit Gate areas are revealed to you. Once per Trial, hooking a Survivor while Blood Warden is active calls upon The Entity to block both Exits for all Survivors for 60 seconds.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/BloodWarden.png'} ,
'Hangman\'s Trick' : {'name': 'Pig', 'description': "Unlocks potential in one's Aura-reading ability. All regressing Generators will be highlighted by a white Aura. Once regression ends, Generators will be highlighted by a yellow Aura for 16 seconds. Noises created by Generator Repairs are audible at an additional 8 metres.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/HangmansTrick.png'} ,
'Surveillance' : {'name': 'Pig', 'description': "Unlocks potential in one's Aura-reading ability. All regressing Generators will be highlighted by a white Aura. Once regression ends, Generators will be highlighted by a yellow Aura for 16 seconds. Noises created by Generator Repairs are audible at an additional 8 metres.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Surveillance.png'} ,
'Make Your Choice' : {'name': 'Pig', 'description': 'When a Survivor rescues another Survivor from a Hook that is at least 32 metres away from you, Make Your Choice triggers and applies the Exposed Status Effect on the rescuer for 60 seconds. Make Your Choice has a cool-down of 60 seconds.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/MakeYourChoice.png'} ,
'Bamboozle' : {'name': 'Clown', 'description': 'Your vault speed is 15 % faster. Performing a vault action calls upon The Entity to block that vault location for 16 seconds. Only one vault location may be blocked in this way at any given time. The vault location is blocked only for Survivors. Bamboozle does not affect Pallets.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Bamboozle.png'} ,
'Coulrophobia' : {'name': 'Clown', 'description': 'Your presence alone instils great fear. Survivors within your Terror Radius have a 50 % penalty to the Healing progression speed.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Coulrophobia.png'} ,
'Pop Goes the Weasel' : {'name': 'Clown', 'description': 'A deep bond with The Entity unlocks great strength. After hooking a Survivor, the next Generator you damage is instantly loses 25% of its progress. Normal Generator Regression applies after the Damage Generator action. Pop Goes the Weasel is active for 35/40/45 seconds after the Survivor is hooked.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/PopGoestheWeasel.png'} ,
'Spirit Fury' : {'name': 'Spirit', 'description': 'Each Pallet you break magnifies the wrath of The Entity. After breaking 2 Pallets, the next time you are stunned by a Pallet, The Entity will instantly break it. You still suffer from the stun effect penalty.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/SpiritFury.png'} ,
'Hex: Haunted Ground' : {'name': 'Spirit', 'description': 'Two trapped Hex Totems will spawn in the Trial. When one of the two trapped Hex Totems is cleansed by a Survivor, all Survivors suffer from the Exposed Status Effect for 60 seconds. The remaining trapped Hex Totem immediately becomes a Dull Totem.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/HexHauntedGround.png'} ,
'Rancor' : {'name': 'Spirit', 'description': "You become obsessed with one  Each time a Generator is completed, the Obsession sees your Aura for 3 seconds. Each time a Generator is completed, all Survivors' locations are revealed to you for 3 seconds. Once all Generators are completed, the Obsession has the Exposed Status Effect and the Killer can kill the  You can only be obsessed with one Survivor at a time.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Rancor.png'} ,
'Discordance' : {'name': 'Legion', 'description': 'Any Generator within a range of 64/96/128 metres that is being repaired by 2 or more Survivors is marked by a yellow Aura. When the Generator is first highlighted, Discordance triggers a Loud Noise notification on the Generator. After the Generator is no longer within range or is being repaired by just 1 Survivor, the highlighted Aura remains for another 4 seconds.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Discordance.png'} ,
'Mad Grit' : {'name': 'Legion', 'description': "While carrying a Survivor, you suffer no cool-down on missed attacks and successfully hitting another Survivor will pause the carried Survivor's wiggle timer for 4 seconds.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/MadGrit.png'} ,
'Iron Maiden' : {'name': 'Legion', 'description': 'You open Lockers 50 % faster. Survivors who exit Lockers suffer from the Exposed Status Effect for 15 seconds and their location is revealed for 4 seconds.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/IronMaiden.png'} ,
'Corrupt Intervention' : {'name': 'Plague', 'description': "Your prayers invoke a dark power that meddles with the Survivors' chances of survival. 3 Generators located farthest from you are blocked by The Entity for 120 seconds at the start of the Trial. Survivors cannot repair the Generators for the duration Corrupt Intervention is active.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/CorruptIntervention.png'} ,
'Infectious Fright' : {'name': 'Plague', 'description': "The cries of the unfaithful make your heart leap. Any Survivors that are within the Killer's Terror Radius while another Survivor is put into the Dying State with a Basic Attack will yell and reveal their current location to the Killer for 6 seconds.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/InfectiousFright.png'} ,
'Dark Devotion' : {'name': 'Plague', 'description': 'The display of your Powers creates a whirlwind of panic that spreads throughout the land. You become obsessed with one Survivor. Hitting the Obsession with your basic attack causes the Obsession to emit a Terror Radius of 32 metres for 30 seconds. During that time, your Terror Radius is reduced to 0 metres. The Obsession hears the Terror Radius they emit for the duration. You can only be obsessed with one Survivor at a time.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/DarkDevotion.png'} ,
'I\'m All Ears' : {'name': 'Ghost Face', 'description': "Your keen senses are sharpened in the dark Realm of The Entity. Unlocks potential in one's Aura-reading ability. Any Survivor performing a rushed action within 48 metres from your location will have their Aura revealed to you for 6 seconds. I'm All Ears can only be triggered once every 40 seconds.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/ImAllEars.png'} ,
'Thrilling Tremors' : {'name': 'Ghost Face', 'description': 'Your dark designs and shrewd composure rouse The Entity. After picking up a Survivor, all Generators not being repaired by Survivors are blocked by The Entity and cannot be repaired for the next 16 seconds. Affected Generators are highlighted by a white Aura. Thrilling Tremors can only be triggered once every 60 seconds.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/ThrillingTremors.png'} ,
'Furtive Chase' : {'name': 'Ghost Face', 'description': 'You become obsessed with one Survivor. You lurk in the shadows, eliminating your victims one by one. When your Obsession is hooked, Furtive Chase receives a Token, up to a maximum of 4 Tokens. Each Token decreases your Terror Radius by 4 metres while in a Chase. When a Survivor rescues the Obsession from a Hook, the rescuer becomes the Obsession. You lose all Tokens if the Obsession is sacrificed or killed. You can only be obsessed with one Survivor at a time.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/FurtiveChase.png'} ,
'Surge' : {'name': 'Demogorgon', 'description': 'Your eerie presence charges the air and interferes with technology. Putting a Survivor into the Dying State with a Basic Attack causes all Generators within a radius of 32 metres to instantly explode and regress. Surge applies an immediate Regression penalty of 8 %. Surge can only be triggered once every 40 seconds.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Surge.png'} ,
'Mindbreaker' : {'name': 'Demogorgon', 'description': 'Your distressing presence drains and weakens your prey. While repairing Generators, Survivors are afflicted by the Exhausted Status Effect. Any existing Exhaustion timers are paused while the Survivor is repairing a Generator. After ending the Repair action, the Survivor is afflicted by the Exhausted Status Effect for 3/4/5 seconds.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Mindbreaker.png'} ,
'Cruel Limits' : {'name': 'Demogorgon', 'description': 'Your ties to the otherworldly manifest when your prey attempts to get away. Each time a Generator is repaired, all Windows and vault locations within a radius of 32 metres from the completed Generator are blocked for all Survivors for the next 20/25/30 seconds.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/CruelLimits.png'} ,
'Zanshin Tactics' : {'name': 'Oni', 'description': "Unlocks potential in one's Aura-reading ability. You are mentally alert and aware of key points on the battlefield. The Auras of all Pallets and Windows are revealed to you within a range of 24 metres. When a Survivor is damaged, Zanshin Tactics becomes inactive for 30 seconds.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/ZanshinTactics.png'} ,
'Blood Echo' : {'name': 'Oni', 'description': 'The agony of one is inflicted on others. When hooking a Survivor, all other injured Survivors suffer from the Haemorrhage Status Effect until healed and the Exhausted Status Effect for 45 seconds. Blood Echo can only be triggered once every 60 seconds.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/BloodEcho.png'} ,
'Nemesis' : {'name': 'Oni', 'description': 'You seek retribution on those who have wronged you. A Survivor who blinds or stuns you using a Pallet or a Locker becomes your Obsession. Anytime a new Survivor becomes the Obsession, they are affected by the Oblivious Status Effect for 60 seconds and their Aura is revealed to you for 4 seconds. You can only be obsessed with one Survivor at a time.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Nemesis.png'} ,
'Bitter Murmur' : {'name': 'All', 'description': "Unlocks potential in one's Aura-reading ability. Each time a Generator is fully repaired, Survivors within 16 metres of the completed Generator will be revealed for 5 seconds. When the last Generator is fully repaired, all the Survivors' Auras are revealed for 10 seconds.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/BitterMurmur.png'} ,
'Deerstalker' : {'name': 'All', 'description': "Unlocks potential in one's Aura-reading ability. Reveals dying Survivors' Auras when standing within 36 metres.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Deerstalker.png'} ,
'Distressing' : {'name': 'All', 'description': 'Your horrifying emanation strikes at a supernaturally long distance. Your Terror Radius is increased by 26 %. Gain 100 % more Bloodpoints for actions in the Deviousness Category. The Bonus Bloodpoints are only awarded during the Trial.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Distressing.png'} ,
'Hex: No One Escapes Death' : {'name': 'All', 'description': 'A Hex rooting its power on hope. You are animated by the power of your Hex Totem when the Survivors are on the verge of escaping. Once the Exit Gates are powered, if there is a Dull Totem remaining on the Map, this Hex is applied to  While Hex: No One Escapes Death is active, Survivors suffer from the Exposed Status Effect and your Movement speed is increased by 4 %. The Hex effects persist as long as the related Hex Totem is standing.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/HexNoOneEscapesDeath.png'} ,'Hex: Thrill of the Hunt' : {'name': 'All', 'description': "A Hex rooting its power on hope. The false hope of Survivors fills you with excitement and strengthens your totems. For each Dull Totem and Hex Totem remaining on the Map gain a Token. É Gain 10 % more Bloodpoints for actions in the Hunter Category for each Token. É Survivors' cleansing speed is reduced by 6 % for each Token. É Gain a notification when someone starts working on a Hex Totem. The Hex effects persist as long as the related Hex Totem is standing.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/HexThrilloftheHunt.png'} ,
'Insidious' : {'name': 'All', 'description': 'Unlocks the stealth ability. By standing still for 2 seconds, you reduce your Terror Radius to 0 metres and thus become stealthy until you move or act again.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Insidious.png'} ,
'Iron Grasp' : {'name': 'All', 'description': 'Your powerful hold onto the Survivors causes escapes to be nearly impossible. Effects of Survivor struggling are reduced by 75 %. Time to struggle out of your grasp is increased by 12 %.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/IronGrasp.png'} ,
'Monstrous Shrine' : {'name': 'All', 'description': "Your fervent care of the Hooks found in the Basement has aroused The Entity's interest. The Basement Hooks are granted the following bonuses: É 9 % faster Entity progression É 15 % increased difficulty on escape attempts É 9 % increased penalty to escape fails.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/MonstrousShrine.png'} ,
'Sloppy Butcher' : {'name': 'All', 'description': "You know where to hit to make them bleed. Wounds inflicted by successful attacks considerably increase the Survivor's bleeding frequency and cause the Mangled Status  Haemorrhage and Mangled effects caused by Sloppy Butcher return to normal once the Survivor is fully healed.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/SloppyButcher.png'} ,
'Spies from the Shadows' : {'name': 'All', 'description': 'The Crows found in the world can communicate directly with you. 100 % of the time, cawing Crows give you a visual cue when you are within a range of 36 metres. Spies from the Shadows has a cool-down of 5 seconds.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/SpiesfromtheShadows.png'} ,
'Unrelenting' : {'name': 'All', 'description': 'You recuperate faster from missed attacks made with your main weapon. The cool-down of missed Basic Attacks is reduced by 30 %.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Unrelenting.png'} ,
'Whispers' : {'name': 'All', 'description': "You have a rudimentary understanding of The Entity's voice. Sporadically hear The Entity's Whisper when standing within a 32 metres of a Survivor.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Whispers.png'} ,
'Gear Head' : {'name': 'Deathslinger', 'description': "You've got an ear for well-oiled gears. After hitting a Survivor 2 times with your Basic Attack, Gearhead activates for 35/40/45 seconds. Each time a Survivor completes a Good or Great Skill Check while repairing, the Generator will be revealed by a yellow Aura for as long as it is being repairing.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/GearHead.png'} ,
'Dead Man\'s Switch' : {'name': 'Deathslinger', 'description': "You become obsessed with one Survivor. After hooking the Obsession, Dead Man's Switch activates for the next 35/40/45 seconds. While activated, any Survivor that stops repairing a Generator before it is fully repaired causes The Entity to block the Generator until Dead Man's Switch's effect ends. Affected Generators are highlighted by a white Aura.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/DeadMansSwitch.png'} ,
'Hex: Retribution' : {'name': 'Deathslinger', 'description': 'A Hex that lashes out upon its destruction. Those who cross you will be punished. Any Survivor who cleanses a Dull Totem will suffer from the Oblivious Status Effect for 35/40/45 seconds. If any Hex Totem is cleansed, including this one, the Auras of all Survivors are revealed for 10 seconds.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/HexRetribution.png'} ,
'Forced Penance' : {'name': 'The Executioner', 'description': 'Those who stand in the way of duty will suffer harsh judgement. Survivors who take a Protection Hit are inflicted with the Broken Status Effect for 60/70/80 seconds.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/ForcedPenance.png'} ,
'Trail Of Torment' : {'name': 'The Executioner', 'description': "You guide your victims along a path of pain and punishment. After kicking a Generator, you become Undetectable for as long as the Generator is regressing or a Survivor is put into the Dying State by any means. During this time, the Generator's Aura is revealed in yellow to all Survivors. Trail of Torment can only be triggered once every 80/70/60 seconds.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/TrailOfTorment.png'} ,
'Deathbound' : {'name': 'The Executioner', 'description': 'Those whose lives are intertwined in darkness are destined to suffer together. When a Survivor heals another Survivor for one Health State at least 32 metres away from the Killer, the Survivor performing the Healing action will scream, revealing their location and activating Deathbound for the next 60 seconds. During that time, the Survivor will suffer from the Oblivious Status Effect when farther than 16/12/8 metres away from the healed Survivor.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Deathbound.png'} , 
'Dragon\'s Grip' : {'name': 'The Blight', 'description': "After kicking a Generator Generator}}, for the next 30 seconds, the first Survivor that interacts with it will scream, revealing their location for 4 seconds, and becoming afflicted with the Exposed Status Effect for 60 seconds. Dragon's Grip has a cool-down of 120/100/80 seconds.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/DragonsGrip.png'} ,
'Hex: Blood Favour' : {'name': 'The Blight', 'description': 'A Hex that gains the favour of The Entity when blood is spilt. When a Survivor is hit, all Pallets within a radius of 16 metres of your location are held in place by The Entity for 15 seconds and cannot be pulled down by Survivors. Hex: Blood Favour has a cool-down of 60/50/40 seconds.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/HexBloodFavour.png'} ,
'Hex: Undying' : {'name': 'The Blight', 'description': "A Hex which maintains the vile powers that flow throughout the Trial. When Hex: Undying is active and a different Hex Totem is cleansed, that Hex will be transferred to a Dull TotemÉso long as one exists. Survivors' Auras are revealed for 4/5/6 seconds when they are within 2 metres of any Totem.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/HexUndying.png'} ,
'Coup de GrÉce' : {'name': 'Twins', 'description': 'As the end nears, you go in for the kill. Each time a Generator is completed, Coup de GrÉce grows in power. Gain 1 Token per Generator. Consume 1 Token to increase the distance of your next Lunge Attack by 60/80/100 %.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/CoupDeGrace.png'} ,
'Hoarder' : {'name': 'Twins', 'description': 'You protect what little you have and are perceptive to those rummaging through your stockpiles. Receive a Loud Noise notification for 4 seconds when Survivors interact with a Chest or when they pick up an Item within 24/36/48 meters of your location. The Trial begins with up to 2 additional Chests in the environment. The rarity of Items found in all Chests is decreased.', 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Hoarder.png'} ,
'Oppression' : {'name': 'Twins', 'description': "Life has been difficult for you, so you'll make it difficult for others. When you damage a Generator, up to 3 other random Generators also begin regressing. If the affected Generators are being repaired, any Survivors repairing them receive a difficult Skill Check. Oppression has a cool-down of 120/100/80 seconds.", 'icon': 'https://raw.githubusercontent.com/dearvoodoo/dbd/master/Perks/Oppression.png'} ,
'Starstruck' : {'name': 'Trickster', 'description': 'Your unmatched showmanship dazzles all.When carrying a Survivor, Starstruck activates:Survivors suffer from the Exposed Status Effect while in your Terror Radius.The Status Effect lingers for 26/28/30 seconds after leaving your Terror Radius.After hooking or dropping the carried Survivor, Starstruck deactivates:The Status Effect persists for 26/28/30 seconds for any Survivor inside your Terror Radius at that moment.', 'icon': 'https://static.wikia.nocookie.net/deadbydaylight_gamepedia_en/images/f/f2/Starstruck.gif/revision/latest/scale-to-width-down/128?cb=20210302181405'} ,
'Hex: Crowd Control' : {'name': 'Trickster', 'description': 'A Hex that ensures those lesser than you are properly herded.Survivors who perform a rushed vault through a Window prompt The Entity to block it for the next 14/17/20 seconds.The Hex effects persist as long as the related Hex Totem is standing.', 'icon': 'https://static.wikia.nocookie.net/deadbydaylight_gamepedia_en/images/2/2e/HexCrowdControl.gif/revision/latest/scale-to-width-down/128?cb=20210302181441'} ,
'No Way Out' : {'name': 'Trickster', 'description': 'You are not going to let just anyone into the VIP room.For each Survivor you hook for the first time, No Way Out gains 1 Token.Once the Exit Gates have been powered, No Way Out activates:When a Survivor interacts with an Exit Gate Switch, you receive a Loud Noise notification and The Entity blocks both Exit Gate Switches for 12 seconds and an additional 6/9/12 seconds per Token in your possession, up to a combined maximum of 36/48/60 seconds.', 'icon': 'https://static.wikia.nocookie.net/deadbydaylight_gamepedia_en/images/2/2e/HexCrowdControl.gif/revision/latest/scale-to-width-down/128?cb=20210302181441'} ,
'Lethal Pursuer' : {'name': 'Nemesis T-Type', 'description': 'You have been designed to track down and eliminate targets.At the start of the Trial, the Auras of all Survivors are revealed to you for 7/8/9 seconds.', 'icon': 'https://static.wikia.nocookie.net/deadbydaylight_gamepedia_en/images/0/03/LethalPursuer.gif/revision/latest/scale-to-width-down/128?cb=20210526185500'} ,
'Hysteria' : {'name': 'Nemesis T-Type', 'description': 'You know how to brutalise one member of a team to cause a panic.Whenever you put a healthy Survivor into the Injured State, all injured Survivors suffer from the Oblivious Status Effect for 20/25/30 seconds.Hysteria has a cool-down of 30 seconds.', 'icon': 'https://static.wikia.nocookie.net/deadbydaylight_gamepedia_en/images/2/20/Hysteria.gif/revision/latest/scale-to-width-down/128?cb=20210526185454'} ,
'Eruption' : {'name': 'Nemesis T-Type', 'description': 'The NE-α parasite provides you with the intelligence and awareness needed to set a trap.\n\nAfter kicking a Generator, its Aura is highlighted in yellow.\n\nWhen you put a Survivor into the Dying State, every affected Generator explodes and starts regressing, removing the highlighted Aura.\nApplies an immediate 6 % Progression penalty.\nAny Survivor repairing a Generator when it explodes will scream and suffer from the Incapacitated Status Effect for 12/14/16 seconds.\nEruption has a cool-down of 30 seconds.', 'icon': 'https://static.wikia.nocookie.net/deadbydaylight_gamepedia_en/images/e/e1/Eruption.gif/revision/latest/scale-to-width-down/128?cb=20210526185449'} ,
'Deadlock':{'name':'Cenobite', 'description':'You induce mental suffering by crushing any hope of escape.\nWhenever a Generator is completed, The Entity blocks the Generator with the most progression for 20/25/30 seconds.\nThe Aura of the blocked Generator is revealed to you in white during this time.','icon':'https://static.wikia.nocookie.net/deadbydaylight_gamepedia_en/images/d/d3/IconPerks_deadlock.png/revision/latest?cb=20210819105650'},
'Hex:Plaything':{'name':'Cenobite', 'description':'	A Hex that toys with a victim\'s suffering.\nIf there is at least one Dull Totem remaining in the Trial Grounds, Hex: Plaything activates on a random Totem each time a Survivor is hooked for the first time:\nThe Survivors suffers from the Cursed and Oblivious Status Effects until Hex: Plaything is cleansed.\nFor the first 90 seconds, only the Cursed Survivor is able to cleanse the Hex Totem.\nThe Aura  of Hex: Plaything\'s Hex Totem is revealed to the Cursed Survivor within 24/20/16 metres.\nThe Hex effects persist as long as the related Hex Totem is standing.','icon':"https://static.wikia.nocookie.net/deadbydaylight_gamepedia_en/images/1/18/IconPerks_hexPlaything.png/revision/latest?cb=20210819105650"},
'Scourge Hook:Gift of Pain':{'name':'Cenobite', 'description':'You are the bringer of sweet pain.\nAt the start of the Trial, 4 random Hooks are changed into Scourge Hooks:\nThe Auras of Scourge Hooks are revealed to you in white.\nWhen a Survivor is unhooked from a Scourge Hook they suffer from the Haemorrhage and Mangled  Status Effects.\nBoth Status Effects are removed upon being healed.\nUpon being healed, the Survivor suffers from a 7/8/9 % Healing and Repairing Action Speed penalty until they are injured again.','icon':'https://static.wikia.nocookie.net/deadbydaylight_gamepedia_en/images/2/26/IconPerks_scourgeHookGiftOfPain.png/revision/latest?cb=20210819105650'},
}
...
facts= [
                ...
                "Fungus are more closely related to animals on a genetic level than they are to plants.",
                ...
                "\u201cShe sells seashells by the seashore\u201d was written about a female paleontologist from the 1800\u2019s. She actually sold dinosaur bones and fossilized shells.",
                ...
                "Eating a banana can help to form a lining which prevents heartburn from getting worse.",
                ...
                "Applying non-fat yoghurt to a sunburnt area is a natural way to deal with sunburn.",
                ...
                "The mongoose is one of those rare animals that is immune to a snake\u2019s venom.",
                ...
                "Temperature effects your attitude towards others. For example if you hold a warm coffee as opposed to a cold coffee, you are more likely to be more selfless towards others.",
                ...
                "Aaron Carpenter got verified on Instagram on 29th April 2015.",
                "The U.S. government gave Indiana University $1 million to study memes.",
                "Cards Against Humanity celebrated Black Friday by digging a hole as long as people donated. They raised over $100k.",
                ...
                "The very first bottle of Dr Pepper was sold in America on the 12th January, 1885.",
                ...
                "LegoLand Billund opened on the 7th June 1968, and attracted over 3,000 visitors on the first day!",
                ...
                "Li\u00e8ge, Belgium tried to use 37 cats to deliver mail in the 1870\u2019s. Most of the cats took up to a day to deliver the mail, and the service was short lived.",
                ...
                "The letter Z is the least frequently used letter in written English. It is more common in American English than in British English due to spellings differences.",
